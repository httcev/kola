...
//		sql("select * from TASK_DOCUMENTATION into COMMENTABLE")
println "INSERT INTO COMMENTABLE (ID, VERSION, CLASS, CREATOR_ID, DELETED, LAST_UPDATED, REFERENCE_ID, TEXT) SELECT ID, VERSION, '${TaskDocumentation.class.name}', CREATOR_ID, DELETED, LAST_UPDATED, REFERENCE_ID, TEXT FROM TASK_DOCUMENTATION"
