		...
		<g:if test="${!task?.deleted}">
			<h1 class="page-header clearfix">
				...
				<div class="buttons pull-right">
					...
					<g:link class="copy btn btn-primary" action="copyTemplate" id="${task.id}" title="${message(code: 'default.copy.label', args:[entityName])}"><i class="fa fa-copy"></i></g:link>
					</g:if>
					<g:elseif test="${authService.canAttach(task)}">
						...
						<div class="col-md-4 col-md-push-8">
							<div class="well">
								<table class="task-info-table">
									...
									<g:if test="${task?.expires}">
										<tr class="text-danger">
											<td><g:message code="kola.task.expiresAt" />:</td>
											<td><g:formatDate date="${task.expires}" type="date"/></td>
										</tr>
									</g:if>
								</table>
							</div>
