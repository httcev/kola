	...
	<div id="loginWrapper" class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title"><b>Please update your password</b></h1>
			</div>
			<form action="updatePassword" method="POST" role="form" autocomplete="off">
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="password_new" class="control-label"><g:message code="springSecurity.login.password.label" /></label>
					...
					<div class="form-group">
						<label for="password_new_2" class="control-label"><g:message code="springSecurity.login.password.label" /></label>
				...
				<div class="panel-footer text-center">
					<button type="submit" class="btn btn-default">Passwort neu setzen</button>
				</div>
			</form>
		</div>
	</div>
