...
<div class="form-group ${hasErrors(bean: userInstance.profile, field: 'displayName', 'error')} required">
	<label for="displayName" class="col-sm-2 control-label"><g:message code="kola.user.displayName" /><span class="required-indicator">*</span>:</label>
...
<div class="form-group ${hasErrors(bean: userInstance.profile, field: 'company', 'error')} required">
	<label for="company" class="col-sm-2 control-label"><g:message code="kola.user.company" /><span class="required-indicator">*</span>:</label>
	<div class="col-sm-10">
...
<div class="form-group ${hasErrors(bean: userInstance.profile, field: 'phone', 'error')} ">
	<label for="phone" class="col-sm-2 control-label"><g:message code="kola.user.phone" />:</label>
...
<div class="form-group ${hasErrors(bean: userInstance.profile, field: 'mobile', 'error')} ">
	<label for="mobile" class="col-sm-2 control-label"><g:message code="kola.user.mobile" />:</label>
...
<div class="form-group ${hasErrors(bean: userInstance.profile, field: 'photo', 'error')} ">
	<label for="photo" class="col-sm-2 control-label"><g:message code="kola.user.photo" />:</label>
	<div class="col-sm-10">
