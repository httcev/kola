...
<div class="form-group ${hasErrors(bean: reflectionQuestionInstance, field: 'question', 'error')} required">
	<label for="question" class="col-sm-2 control-label"><g:message code="reflectionQuestion.question.labe" default="Aufforderung" /><span class="required-indicator">*</span>:</label>
	<div class="col-sm-10">
